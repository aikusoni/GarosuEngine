...
using namespace GarosuUWPTestApp;
...
App::App()
{
	...
	//gEngineModule = LoadPackagedLibrary(L"GarosuEngine.dll", 0);
	//if (gEngineModule != nullptr)
	//{
	//	typedef Garosu::IEngine* (*mk)(void);
	//	auto MakeGarosuEngine = (mk)GetProcAddress(gEngineModule, "MakeEngine");

	//	if (MakeGarosuEngine != nullptr)
